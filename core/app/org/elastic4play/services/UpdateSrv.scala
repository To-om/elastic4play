...
////
////@Singleton
//class UpdateSrv @Inject() ( //    dbModify: DBModify,
////    getSrv: GetSrv,
...
//  //  }
//  //
//  private[services] def doUpdate[E <: Entity](entity: E, attributes: JsObject)(implicit authContext: AuthContext): Future[E] = ???
...
//  //  }
//  //
//  //  def apply[E <: Entity](entity: E, fields: Fields)(implicit authContext: AuthContext): Future[E] = {
//  //    for {
